  ...
  <div class="template-introduce">
    ...
    <template v-for="(item, i) in items" :key="`items-${i}`">
      <div :class="['_item', `_item-${i}`, `mode-${item.mode}`]">
        ...
        <!-- data -->
        <div v-if="item.data && item.mode != 'tabs'" :class="['_data']">
          <div
          ...
          >
            <!-- header -->
            <div class="_header">
              <div v-if="d.icon" class="_icon">
                <svg-icon :id="d.icon"></svg-icon>
              </div>
              <div class="_title">{{ d.title }}</div>
              <div class="_subhead">{{ d.subhead }}</div>
            </div>
            <!-- body -->
            <div v-if="d.content" class="_body">
              <div v-for="t in d.content" :key="t" >
                {{ t }}
              </div>
            </div>
          </div>
        ...
        <!-- tabs -->
        <div v-if="item.data && item.mode == 'tabs'">
          <el-tabs>
            <el-tab-pane
